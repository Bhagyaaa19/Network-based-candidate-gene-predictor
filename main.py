...
if __name__ == '__main__':
    ...
    protein_graph = script.Network.networkToGraph("string_interactions_short_prototype.tsv")
    ...
    network1 = script.Network("string_interactions_short_prototype.tsv")
    ...
    outputMVSingle = network1.gene_predict_single_function("GO_annotations_single_function.txt")
    print(outputMVSingle)
    print('\n')

    print("\x1B[4m" + "Predicting candidate genes for three functions,using Majority Voting...... " + "\x1B[0m")
    outputMVMultiple = network1.gene_predict_multiple_function("GO_annotations_multiple_functions.tsv")
    print (outputMVMultiple)
    print('\n')

    print(
        "\x1B[4m" + "Predicting most accurate function for unknown proteins,using Majority Voting Scores...... " + "\x1B[0m")
    outputMVFunction = network1.function_predict_multiple_function("GO_annotations_multiple_functions.tsv")
    ...
    outputHSSingle = network1.gene_predict_single_function_Hishigaki("GO_annotations_single_function.txt")
    print(outputHSSingle)
    print('\n')

    print("\x1B[4m" + "Predicting candidate genes for three functions,using Hishigaki Algorithm...... " + "\x1B[0m")
    outputHSMultiple = network1.gene_predict_multiple_function_Hishigaki("GO_annotations_multiple_functions.tsv")
